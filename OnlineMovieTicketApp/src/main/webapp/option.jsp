		...
		<div class="testbox1">
			...
			<form action="userinput" method="POST">
				<input type="text" name="movieName" placeholder="Movie Name"
					required /> <input type="text" name="genere" placeholder="Genere"
					required /> <input type="text" name="duration"
					placeholder="Duration" required /> <input type="text"
					name="director" placeholder="Direction" required /> <br /> <br />
		...
		<div style="float: left; margin-right: 150px;">
			<div class="testbox2">
				...
				<form action="schedule" method="POST">
					<input type="text" name="movieId" placeholder="Movie ID"> <input
						type="text" name="screen" placeholder="Screen No."> <input
						type="text" name="slot" placeholder="Slot No."> <br /> <br />
		...
		<table class="table table-hover" style="margin-top: 350px;">
			...
			<tbody>
               <%
				...
				String query = "select * from moviedatabase01";
				ResultSet rs = null;
