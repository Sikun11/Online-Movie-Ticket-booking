...
<nav class="navbar navbar-inverse" style="margin-bottom: 0px;">
	<div class="container">
		<div class="navbar-header">
			<a class="navbar-brand" href="user.jsp" style="font-size: 40px;"><b>Wave
					Cineplex</b></a>
		</div>
		<ul class="nav navbar-nav navbar-right">
			<!-- <li><a href="#"><span class="glyphicon glyphicon-user"></span> Admin</a></li> -->
			<li><a data-toggle="modal" data-target="#myModal"><span
					class="glyphicon glyphicon-user"></span><b> Admin</b></a></li>
		</ul>
	</div>
</nav>
...
<body style="background: linear-gradient(to bottom, red, yellow);">
	...
	<center>
		...
		<div id="carousel-example-generic"
			class="carousel slide container-fluid pt-5" data-ride="carousel">
			<!-- Indicators -->
		...
		<form action="book" method="post">
				...
				<div class="container" style="float: left; margin-left: 150px;">
					<table class="table table-hover">
						...
						<tbody>
							...
							conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:ORCL", "hyd", "nit");
							Statement stmt = null;
							Statement stmt2 = null;
							stmt = conn.createStatement();
							stmt2 = conn.createStatement();
							String query = "select * from shows01";
							ResultSet rs = null;
							...
							String query2 = "select title, duration from moviedatabase01 where id=" + mid;
							ResultSet rs2 = null;
			...
			<div class="testbox3" style="float: right; margin-right: 150px;">
				...
				</select> <br /> <br /> <input class="btn btn-danger pb-5" type="submit"
					value="BOOK NOW">
